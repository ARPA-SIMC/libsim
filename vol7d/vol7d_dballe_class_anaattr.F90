...
ind = this%vol7d%anavar%/**/VOL7D_POLY_TYPES_V/**/(a)%/**/VOL7D_POLY_TYPES

if (ind > 0) then
  do indanaattr=1,nanaattr/**/VOL7D_POLY_TYPES
    if (lanaattr/**/VOL7D_POLY_TYPES (indanaattr))then
      if (c_e(this%vol7d%volanaattr/**/VOL7D_POLY_TYPES/**/(i,ind,iiiiii,indanaattr)))then
                                !print*,"attr ",this%vol7d%datiattr%/**/VOL7D_POLY_TYPES/**/(indanaattr)%btable,&
                                !this%vol7d%voldatiattr/**/VOL7D_POLY_TYPES/**/(i,ind,iiiiii,indanaattr)
        ier=idba_set (this%handle, this%vol7d%anaattr%/**/VOL7D_POLY_TYPES/**/(indanaattr)%btable,&
         this%vol7d%volanaattr/**/VOL7D_POLY_TYPES/**/(i,ind,iiiiii,indanaattr))
        writeattr=.true.
      end if
    end if
  end do
