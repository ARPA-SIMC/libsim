...
call check( "9",nf90_def_dim(lunit,"btable_len",10, var_len_dimid) )
...
if (nanavarr > 0)then
   call check( "a81" ,nf90_def_var(lunit,"anavarr_btable",NF90_CHAR,&
        (/var_len_dimid ,anavarr_dimid/),anavarr_btable_varid ))
   call check( "a82" ,nf90_def_var(lunit,"anavarr",NF90_REAL,&
        (/ana_dimid,anavarr_dimid,network_dimid/),anavarr_varid ))
end if

if (nanavari > 0) then
   call check( "a83" ,nf90_def_var(lunit,"anavari_btable",NF90_CHAR,&
        (/var_len_dimid ,anavari_dimid/),anavari_btable_varid ))
   call check( "a84" ,nf90_def_var(lunit,"anavari",NF90_INT,&
        (/ana_dimid,anavari_dimid,network_dimid/),anavari_varid ))
end if
if (nanavard > 0) then
   call check( "a85" ,nf90_def_var(lunit,"anavard_btable",NF90_CHAR,&
        (/var_len_dimid ,anavard_dimid/),anavard_btable_varid ))
   call check( "a86" ,nf90_def_var(lunit,"anavard",NF90_DOUBLE,&
        (/ana_dimid,anavard_dimid,network_dimid/),anavard_varid ))
end if
if (nanavarb > 0) then
   call check( "a87" ,nf90_def_var(lunit,"anavarb_btable",NF90_CHAR,&
        (/var_len_dimid ,anavarb_dimid/),anavarb_btable_varid ))
   call check( "a88" ,nf90_def_var(lunit,"anavarb",NF90_BYTE,&
        (/ana_dimid,anavarb_dimid,network_dimid/),anavarb_varid ))
end if
if (nanavarc > 0) then 
   call check( "a89" ,nf90_def_var(lunit,"anavarc_btable",NF90_CHAR,&
        (/var_len_dimid ,anavarc_dimid/),anavarc_btable_varid ))
   call check( "a90" ,nf90_def_var(lunit,"anavarc",NF90_CHAR,&
        (/anavarc_len_dimid,ana_dimid,anavarc_dimid,network_dimid/),anavarc_varid ))
end if
...
if (ndativarr > 0) then
   call check( "d81" ,nf90_def_var(lunit,"dativarr_btable",NF90_CHAR,&
        (/var_len_dimid ,dativarr_dimid/),dativarr_btable_varid ))
   call check( "d82" ,nf90_def_var(lunit,"dativarr",NF90_REAL,&
        (/ana_dimid,time_dimid,level_dimid,timerange_dimid,dativarr_dimid,network_dimid/),dativarr_varid ))
end if
if (ndativari > 0) then
   call check( "d83" ,nf90_def_var(lunit,"dativari_btable",NF90_CHAR,&
        (/var_len_dimid ,dativari_dimid/),dativari_btable_varid ))
   call check( "d84" ,nf90_def_var(lunit,"dativari",NF90_INT,&
        (/ana_dimid,time_dimid,level_dimid,timerange_dimid,dativari_dimid,network_dimid/),dativari_varid ))
end if
if (ndativard > 0) then
   call check( "d85" ,nf90_def_var(lunit,"dativard_btable",NF90_CHAR,&
        (/var_len_dimid ,dativard_dimid/),dativard_btable_varid ))
   call check( "d86" ,nf90_def_var(lunit,"dativard",NF90_DOUBLE,&
        (/ana_dimid,time_dimid,level_dimid,timerange_dimid,dativard_dimid,network_dimid/),dativard_varid ))
end if
if (ndativarb > 0) then
   call check( "d87" ,nf90_def_var(lunit,"dativarb_btable",NF90_CHAR,&
        (/var_len_dimid ,dativarb_dimid/),dativarb_btable_varid ))
   call check( "d88" ,nf90_def_var(lunit,"dativarb",NF90_BYTE,&
        (/ana_dimid,time_dimid,level_dimid,timerange_dimid,dativarb_dimid,network_dimid/),dativarb_varid ))
end if
if (ndativarc > 0) then
   call check( "d89" ,nf90_def_var(lunit,"dativarc_btable",NF90_CHAR,&
        (/var_len_dimid ,dativarc_dimid/),dativarc_btable_varid ))
   call check( "d90" ,nf90_def_var(lunit,"dativarc",NF90_CHAR,&
        (/dativarc_len_dimid,ana_dimid,time_dimid,level_dimid,timerange_dimid,dativarc_dimid,network_dimid/),dativarc_varid ))
end if
...
if (associated(this%anavar%r)) then
    call check( "a291",nf90_put_var(lunit, anavarr_btable_varid,this%anavar%r(:)%btable))
end if
if (associated(this%anavar%i)) then
    call check( "a292",nf90_put_var(lunit, anavari_btable_varid,this%anavar%i(:)%btable))
end if
if (associated(this%anavar%d)) then
    call check( "a293",nf90_put_var(lunit, anavard_btable_varid,this%anavar%d(:)%btable))
end if
if (associated(this%anavar%b)) then
    call check( "a294",nf90_put_var(lunit, anavarb_btable_varid,this%anavar%b(:)%btable))
end if
if (associated(this%anavar%c)) then
    call check( "a295",nf90_put_var(lunit, anavarc_btable_varid,this%anavar%c(:)%btable))
end if
...
if (associated(this%dativar%r)) then
    call check( "d291",nf90_put_var(lunit, dativarr_btable_varid,this%dativar%r(:)%btable))
end if
if (associated(this%dativar%i)) then
    call check( "d292",nf90_put_var(lunit, dativari_btable_varid,this%dativar%i(:)%btable))
end if
if (associated(this%dativar%d)) then
    call check( "d293",nf90_put_var(lunit, dativard_btable_varid,this%dativar%d(:)%btable))
end if
if (associated(this%dativar%b)) then
    call check( "d294",nf90_put_var(lunit, dativarb_btable_varid,this%dativar%b(:)%btable))
end if
if (associated(this%dativar%c)) then
    call check( "d295",nf90_put_var(lunit, dativarc_btable_varid,this%dativar%c(:)%btable))
end if



!!$if (associated(this%volanar))      write(unit=lunit)this%volanar
if (associated(this%volanar))call check("a231", nf90_put_var(lunit,anavarr_varid,this%volanar))
if (associated(this%volanai))call check("a232", nf90_put_var(lunit,anavari_varid,this%volanai))
if (associated(this%volanad))call check("a233", nf90_put_var(lunit,anavard_varid,this%volanad))
if (associated(this%volanab))call check("a234", nf90_put_var(lunit,anavarb_varid,this%volanab))
if (associated(this%volanac))call check("a235", nf90_put_var(lunit,anavarc_varid,this%volanac))


if (associated(this%voldatir))call check("d231", nf90_put_var(lunit,dativarr_varid,this%voldatir))
if (associated(this%voldatii))call check("d232", nf90_put_var(lunit,dativari_varid,this%voldatii))
if (associated(this%voldatid))call check("d233", nf90_put_var(lunit,dativard_varid,this%voldatid))
if (associated(this%voldatib))call check("d234", nf90_put_var(lunit,dativarb_varid,this%voldatib))
if (associated(this%voldatic))call check("d235", nf90_put_var(lunit,dativarc_varid,this%voldatic))
