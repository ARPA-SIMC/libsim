...
function peeled/**/VOL7D_POLY_TYPES_SUBTYPES(data,flag0,flag1,flag2,flag3)
...
VOL7D_POLY_TYPE :: peeled/**/VOL7D_POLY_TYPES_SUBTYPES(size(data,1),size(data,2),size(data,3),size(data,4),size(data,5))
      ...
      do j=1,size(data,2)
        do i=1,size(data,1)
          ...
          if (qcsummaryflag/**/VOL7D_POLY_SUBTYPES(flag0l,flag1l,flag2l,flag3l)) then
            peeled/**/VOL7D_POLY_TYPES_SUBTYPES(i,j,k,l,m)=data(i,j,k,l,m)
          else
            peeled/**/VOL7D_POLY_TYPES_SUBTYPES(i,j,k,l,m)=VOL7D_POLY_TYPES/**/miss
          end if
...
end function peeled/**/VOL7D_POLY_TYPES_SUBTYPES
