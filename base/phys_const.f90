...
DOUBLEPRECISION, PARAMETER :: gearth = 9.80665 !< accelerazione gravitazionale media alla superficie terrestre (\f$m/s^2\f$)
...
DOUBLEPRECISION,parameter  :: convff = 1.94  !< fattore di conversione da KT a m/s
! c1 era parameter(c1=0.378)
DOUBLEPRECISION,parameter  :: c1 = 1.- mwater/mdry  !< 1. - ( mwater/mdry ) 
