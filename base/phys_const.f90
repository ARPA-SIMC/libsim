...
! coefficents for Tetens formula, from Murray, 1967, J.Appl.Meteor.
REAL,PARAMETER :: tetens_aw = 17.2694 !< a coefficient over water
...
! coefficents for Tetens formula, from Murray, 1967, J.Appl.Meteor.
DOUBLEPRECISION,PARAMETER :: tetens_aw = 17.2694D0 !< a coefficient over water
