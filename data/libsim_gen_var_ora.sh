...
165,B11001,gsess->DEGREE TRUE,103,10000,0,0,0,0,0,Vento: direzione media degli ultimi 10 minuti (IDRO),WIND DIRECTION,1.0,0.0
166,B11002,M/S->M/S,103,10000,0,0,0,0,0,Vento: velocita' media degli ultimi 10 minuti (IDRO),WIND SPEED,1.0,0.0
...
222,B11001,degree true->DEGREE TRUE,103,10000,0,0,0,0,0,vento direzione (LOKM),WIND DIRECTION,1.0,0.0
223,B11002,m/s/10->M/S,103,10000 0,0,0,0,0,vento velocita' (LOKM),WIND SPEED,0.1,0.0
...
# 4,B11001,gsess->DEGREE TRUE,103,10000,0,0,200,0,0,vento direzione (SYNOP),WIND DIRECTION,1.0,0.0
# 5,B11002,nodi->M/S,103,10000,0,0,200,0,0,vento velocita' (SYNOP),WIND SPEED
# 4,B11001,gsess->DEGREE TRUE,103,10000,0,0,200,0,0,vento direzione (SYNOP),WIND DIRECTION,1.0,0.0
